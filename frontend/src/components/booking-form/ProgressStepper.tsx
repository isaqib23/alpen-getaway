...
// Custom Race Car Icon Component
const RaceCarIcon = () => (
  <svg
    fill="#FF0000"
    height="50px"
  ...
  return (
    <div
      style={{
        ...
        height: 24,
        borderRadius: "50%",
        backgroundColor: active || completed ? "#FF0000" : "#E0E0E0",
        color: "#FFFFFF",
        fontWeight: "bold",
      }}
    >
...
const ProgressStepper: React.FC<ProgressStepperProps> = ({
  ...
  const getCarPosition = () => {
    ...
    return `${activeStep * stepWidth}%`;
  };

  return (
    <div className="progress-container">
      <div className="stepper-with-car">
