...
const BookingList = ({
  ...
  const getDate = (date?: string) => {
    if (date) {
      ...
      return `${bookcarsHelper.formatDatePart(
        d.getDate()
      )}-${bookcarsHelper.formatDatePart(d.getMonth() + 1)}-${d.getFullYear()}`;
    }
