...
// This is a simplified version since we can't import actual Stripe components
const PaymentDetailsSection: React.FC<PaymentDetailsProps> = ({
  ...
  return (
    <div className="booking-form-section payment-details-section">
      ...
      <div className="payment-details">
        <div className="price-display">
          ...
          <div className="price-container">
            <h4 className="price-heading">Total Price: $ {price}</h4>
          </div>
        </div>
      ...
      <button className="btn-default mt-4" style={{ float: "right" }}>
        Update Booking
      </button>
    </div>
  );
