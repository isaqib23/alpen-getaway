...
const strings = new LocalizedStrings({
  fr: {
    ...
    AIRCON: "Climatisé",
    MORE_DOORS: "Plus de 4 portes",
    MORE_SEATS: "Plus de 5 places",
    OOPS: "Oups",
    YES: "Oui",
    NO: "Non",
    AMENITIES: "Équipements",
    DESCRIPTION: "Aucune voiture disponible avec ces fonctionnalités",
  ...
  en: {
    ...
    MORE_DOORS: "More than 4 doors",
    MORE_SEATS: "More than 5 seats",
    OOPS: "Oops",
    DESCRIPTION: "No cars available with these features",
    YES: "Yes",
    NO: "No",
    AMENITIES: "Amenities",
