    ...
    <ReCaptchaProvider>
      <Layout onLoad={onLoad}>
        {visible && car && from && to && pickupLocation && dropOffLocation && (
          <>
            <PageHeader
              title={car ? car.name : "Car Name"}
              breadcrumb={[
                commonStrings.HOME,
                csStrings.CAR,
                car.type === bookcarsTypes.CarType.PlugInHybrid
                  ? csStrings.PLUG_IN_HYBRID
                ...
                <div className="row">
                  <div className="col-lg-4">
                    <FleetsSingleSidebar
                      ...
                      adManuallyChecked={adManuallyChecked}
                      clientSecret={clientSecret}
                      pickupLocation={pickupLocation}
                      dropOffLocation={dropOffLocation}
                      authenticated={authenticated}
                      emailRegistered={emailRegsitered}
                      emailValid={emailValid}
                      emailInfo={emailInfo}
                      phoneValid={phoneValid}
                      phoneInfo={phoneInfo}
                      birthDateValid={birthDateValid}
                      additionalEmailValid={additionalDriverEmailValid}
                      additionalPhoneValid={additionalDriverPhoneValid}
                      additionalBirthDateValid={additionalDriverBirthDateValid}
                      ...
                      onAdditionalFullNameChange={
                        handleAdditionalFullNameChange
                      }
                      onAdditionalEmailChange={handleAdditionalEmailChange}
                      onAdditionalEmailBlur={handleAdditionalEmailBlur}
                      onAdditionalPhoneChange={handleAdditionalPhoneChange}
                      onAdditionalPhoneBlur={handleAdditionalPhoneBlur}
                      onAdditionalBirthDateChange={
                        handleAdditionalBirthDateChange
                      }
                      onTosChange={handleTosChange}
                  ...
                  <div className="col-lg-8">
                    <FleetSingleContent
                      ...
                      onTheftProtectionChange={handleTheftProtectionChange}
                      onCollisionDamageWaiverChange={
                        handleCollisionDamageWaiverChange
                      }
                      onFullInsuranceChange={handleFullInsuranceChange}
                      onAdditionalDriverChange={handleAdditionalDriverChange}
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="section-title">
            ...
            <h2>
              <TextAnime className="text-anime-style-3" tag="h2">
                {payLater ? strings.PAY_LATER_SUCCESS : strings.SUCCESS}
              </TextAnime>
            </h2>
          </div>
        )}
