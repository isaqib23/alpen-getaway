...
const switchStyle = {
  "& .MuiSwitch-switchBase": {
    "&.Mui-checked": {
      color: "#ff3600 !important", // Checked thumb color
      "& + .MuiSwitch-track": {
        backgroundColor: "#ff3600 !important", // Checked track color
        opacity: 0.6, // Ensure full opacity when checked
      },
    },
    color: "#FC8C6D !important", // Unchecked thumb color
  },
  "& .MuiSwitch-track": {
    backgroundColor: "#FF3600 !important", // Unchecked track color
  },
};
            ...
            <form onSubmit={handleSubmit}>
              ...
              <FormControl fullWidth margin="dense">
                <FormControlLabel
                  disabled={
                    !edit ||
                    (booking.car as bookcarsTypes.Car).cancellation === -1 ||
                    (booking.car as bookcarsTypes.Car).cancellation === 0
                  }
                  control={
                    <Switch
              ...
              <FormControl fullWidth margin="dense">
                <FormControlLabel
                  disabled={
                    !edit ||
                    (booking.car as bookcarsTypes.Car).amendments === -1 ||
                    (booking.car as bookcarsTypes.Car).amendments === 0
                  }
                  control={
                    <Switch
                      checked={amendments}
              ...
              <FormControl fullWidth margin="dense">
                <FormControlLabel
                  disabled={
                    !edit ||
                    (booking.car as bookcarsTypes.Car).collisionDamageWaiver ===
                      -1 ||
                    (booking.car as bookcarsTypes.Car).collisionDamageWaiver ===
                      0
                  }
              ...
              <FormControl fullWidth margin="dense">
                <FormControlLabel
                  disabled={
                    !edit ||
                    (booking.car as bookcarsTypes.Car).theftProtection === -1 ||
                    (booking.car as bookcarsTypes.Car).theftProtection === 0
                  }
                  control={
                    <Switch
              ...
              <FormControl fullWidth margin="dense">
                <FormControlLabel
                  disabled={
                    !edit ||
                    (booking.car as bookcarsTypes.Car).fullInsurance === -1 ||
                    (booking.car as bookcarsTypes.Car).fullInsurance === 0
                  }
                  control={
                    <Switch
              ...
              <FormControl fullWidth margin="dense">
                <FormControlLabel
                  disabled={
                    !edit ||
                    (booking.car as bookcarsTypes.Car).additionalDriver ===
                      -1 ||
                    (booking.car as bookcarsTypes.Car).additionalDriver === 0
                  }
                  control={
                    <Switch
                ...
                {edit && (
                  <div className="booking-buttons">
                    <Button
                      variant="contained"
                      sx={{
                        backgroundColor: "#ff3600", // Replace with your desired color
                        borderRadius: "25px  ",
                        margin: "5px",
                        "&:hover": {
                          backgroundColor: "#000", // Replace with hover color
                        },
                      }}
                      type="submit"
                    >
