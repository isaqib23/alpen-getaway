...
export class InitialAlpenSchema1751889593199 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "drivers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "license_number" character varying NOT NULL, "license_expiry" date NOT NULL, "date_of_birth" date NOT NULL, "address" text, "city" character varying, "state" character varying, "postal_code" character varying, "emergency_contact_name" character varying, "emergency_contact_phone" character varying, "profile_photo_url" character varying(500), "background_check_status" "public"."drivers_background_check_status_enum" NOT NULL DEFAULT 'pending', "medical_clearance" boolean NOT NULL DEFAULT false, "training_completed" boolean NOT NULL DEFAULT false, "average_rating" numeric(3,2) NOT NULL DEFAULT '0', "total_rides" integer NOT NULL DEFAULT '0', "status" "public"."drivers_status_enum" NOT NULL DEFAULT 'active', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_47543bd8e5e11a094ded9a56e98" UNIQUE ("license_number"), CONSTRAINT "REL_8e224f1b8f05ace7cfc7c76d03" UNIQUE ("user_id"), CONSTRAINT "PK_92ab3fb69e566d3eb0cae896047" PRIMARY KEY ("id"))`);
